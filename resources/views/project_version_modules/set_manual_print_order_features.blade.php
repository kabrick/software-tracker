                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8"><h3 id="module_div_title">Feature Print Order</h3></div>
                                <div class="col-md-4">
                                    <a href="/project_version_modules/set_manual_print_order/{{ $project_version->id }}" class="btn btn-outline-info btn-rounded">Set Modules Print Order</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            {{ Form::open(['route' => 'project_version_modules.save_manual_print_order_features']) }}
                            {{ Form::hidden('version_id', $project_version->id, ['id' => 'version_id']) }}

                            <div id="module_details_div">@include('flash::message')</div>
                            <br>

                            {{ Form::button('Save Features Print Order',['type'=>'submit','class'=>'btn btn-success waves-effect waves-light m-r-10']) }}
                            {{ Form::close() }}
                        </div>
                    </div>
                </div>
...
@push('js')
    <script>
        ...
        function select_module(module_id) {
            ...
            $.ajax({
                method: 'GET',
                url: '/project_version_modules/fetch_module_details_lists_features/' + module_id,
                success: function(response){
